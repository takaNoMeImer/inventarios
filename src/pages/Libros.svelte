<script>
    ...
    const loadData = async () => {
        const response = await axios.get("http://localhost:8000/libros/all");
...
<div class="table-container">
    ...
    <div class="acciones">
        <p>Lista de Libros</p>
        <a href="/editoriales/agregar"><button class="button is-success">Agregar</button></a>
    </div>
    <table class="table">
        <thead>
            <tr>
                <th><abbr title="Position">Codigo del libro</abbr></th>
